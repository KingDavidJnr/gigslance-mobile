export const BaseUrl = "https://www.gigslance.com/wp-json/api/v1/";
...
export const TextColorDark= "#323232"
export const TextColorGrey= "#767676"
...
//For Welcome Screen
export const welcomeMain = "Welcome to Gigslance, the online marketplace for freelancers";
...
export const DrawerManageJobs = "Manage Jobs";
export const DrawerPostJob = "Post a Job";
export const DrawerPostedJobs = "Posted Jobs";
export const DrawerProposalJobs = "Your Proposals";
export const DrawerOngoingJobs = "Ongoing Jobs";
export const DrawerCompletedJobs = "Completed Jobs";
export const DrawerCancelledJobs = "Cancelled Jobs";
...
export const EmployersOpenJobs = "Open Jobs";
...
export const PostJobPickFreelancerLevel = "Pick Freelancer Type";
...
export const PostJobLatiandLongi = "Latitudes and Longitudes are compulsory to show that user on map and also for search on the basis of location";
...
export const PostedJob = "Posted Jobs";
...
export const ViewProposalsHireFreelancer = "Hire freelancer";
export const ViewProposalsSureHireFreelancer = "Are you sure you want to hire this freelancer";
...
//For Freelancers
export const FreelancersFound = "Freelancers found:";
export const FreelancerFound = "Freelancer found:";
...
export const DetailCompanyScreenDetailEmployers = "Detail Employers";
...
//For DetailJobScreen 
export const DetailjobHadder = "Detail Jobs";
export const DetailjobCarrer = "Project Level";
...
export const SearchFreelancer = "Freelancer";
export const SearchJobs = "Jobs";
export const SearchEmployer = "Employer";
export const SearchServices = "Services";
...
export const SearchButtonFreelancer = "Search Freelancer";
...
export const SearchSearchResultFreelancers = "Search Result Freelancers";
...
export const SearchFreelancersFound= "Freelancers found";
export const SearchServicesFound = "Services found";
export const SearchJobsFound = "Jobs found";
export const SearchPickFreelancerLevel = "Pick Freelancer Level";
...
export const DetailServiceHadder = "Detail Service";
...
export const HomeFreelancer = "Featured Freelancer";
...
export const HomeBottomTabJobs = "Jobs";
export const HomeBottomTabFreelancer = "Freelancer";
...
export const Forgetmain = "Welcome to Gigslance";
...
export const Loginmain = "Welcome to Gigslance";
...
export const Signupmain = "Join Gigslance today";
...
export const SignupFreelancer = "Freelancer";
...
export const VerifyAccountmain = "Verify your Identity";
...
//For ManageJobs
export const ManageJobsOngoingJobs = "Ongoing Jobs";
...
export const SecuritySettingDetail= "If you change your password, this will be updated for your freelancer and employer accounts, if you have switched the profiles.";
...
export const AboutUsMain="Gigslance is the world's marketplace for freelancers to engage their professional talents with independent clients. ";
export const AboutUsCompany="Company";
export const AboutUsCompanyName="Gigslance Global Ltd";
export const AboutUsAPPversionText="Gigslance Mobile";
export const AboutUsAppVersion="1.0.0";

//Contact Support
export const ContactNumberContactSupport="Contact Support";
export const ContactNumberHeader="Phone Numbers:";
export const ContactNumberOne="+2347035175606";
export const ContactNumberTwo="+2347035175606";
export const ContactEmailHeader="Emails Address:";
export const ContactEmailOne="info@gigslance.com";
export const ContactEmailTwo="support@gigslance.com";
