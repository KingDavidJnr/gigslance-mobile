              ...
              <View style={styles.HomejobTextBAckground}>
                {spinnerCategory ?
                  <View style={{
                    ...
                    <View style={{ flexDirection: "row", alignItems: "center", marginTop: 10, overflow: 'hidden', marginHorizontal: 10 }}>
                      <View style={{
                        padding: 10,
                        width: 150,
                        marginRight: 5,
                        ...
                        <SkeletonPlaceholder>
                          <View style={{flexDirection: 'row', alignItems: 'center',}}>
                              <View style={{width: 45, height: 45, marginRight: 20}}/>
                            <View>
                              {/* <View style={{height: 15, width: 70, borderRadius: 5, marginBottom: 10}}/> */}
                      ...
                      <View style={{
                        ...
                        <SkeletonPlaceholder>
                          <View style={{flexDirection: 'row', alignItems: 'center',}}>
                              <View style={{width: 45, height: 45, marginRight: 20}}/>
                            <View>
                              <View style={{height: 10, width: 40, borderRadius: 5, marginBottom: 10}}/>
                              <View style={{height: 10, width: 60, borderRadius: 5}}/>
                            </View>
                          </View>
                        </SkeletonPlaceholder>
                  ...
                  <View
                    ...
                    <View
                      ...
                      <Text style={[styles.MainHeadingTextStyle, {paddingBottom:0, color: CONSTANT.TextColorLight}]}>
                        {CONSTANT.HomeCategories}
                      </Text>
                      <Text style={[styles.OtherTextStyle, {color:CONSTANT.TextColorLight}]}>
                      ...
                      <SkeletonPlaceholder>
                        <View style={{flexDirection: 'row', alignItems: 'center'}}>
                          ...
                          <View>
                            ...
                            <View style={{height: 10, width: 110, borderRadius: 5}}/>
                          </View>
                        </View>
                      </SkeletonPlaceholder>
                    </View>
                  ...
                  <>
                    {this.state.fetchFreelancer.length >= 1 &&
                      <View>
                        <View style={styles.section}>
                          <Text
                            style={[styles.MainHeadingTextStyle, {paddingBottom:0}]}>
                            {CONSTANT.HomeFreelancer}
                          </Text>
                          <Text
                            style={[styles.OtherTextStyle, {color:CONSTANT.TextColorDark}]}>
                ...
                {spinnerJobs ?
                  <View style={{marginTop: 20}}>
                    ...
                    <View style={{flexDirection: 'row'}}>
                      <View style={{
                        ...
                        <SkeletonPlaceholder>
                          <View>
                            <View style={{height: 10, width: 70, borderRadius: 5, marginBottom: 15}}/>
                            <View style={{height: 15, width: 190, borderRadius: 5, marginBottom: 15}}/>
                            <View style={{height: 10, width: 100, borderRadius: 5, marginBottom: 15}}/>
                            <View style={{height: 10, width: 90, borderRadius: 5, marginBottom: 15}}/>
                            <View style={{height: 10, width: 70, borderRadius: 5, marginBottom: 15}}/>
                            <View style={{height: 10, width: 120, borderRadius: 5, marginBottom: 15}}/>
                            <View style={{height: 10, width: 90, borderRadius: 5, marginBottom: 15}}/>
                          </View>
                        </SkeletonPlaceholder>
                      </View>
                  ...
                  :
                  <>
                  {this.state.ApplicationAccessJob === "yes" && this.state.fetchJobs.length >= 1 ?
                    <View style={styles.section}>
                      <View>
                        <Text
                          style={[styles.MainHeadingTextStyle, {paddingBottom:0}]}>
                ...
                {spinnerServices ?
                  <View style={{marginTop: 20}}>
                    ...
                    <View style={{flexDirection: 'row', marginHorizontal: 10, flexWrap: 'wrap'}}>
                      <View
                        style={{
                          height: 250,
                          width: '48.5%',
                      ...
                      >
                        ...
                        <SkeletonPlaceholder>
                          <View style={{marginLeft: 10}}>
                            ...
                            <View style={{height: 15, width: 150, borderRadius: 5, marginBottom: 15, marginTop: 5 }}/>
                            <View style={{height: 10, width: 70, borderRadius: 5, marginBottom: 10}}/>
                  ...
                  <>
                    ...
                    <View>
                      <View style={styles.section}>
                        ...
                        <Text style={[styles.OtherTextStyle, {color:CONSTANT.TextColorDark}]}>
